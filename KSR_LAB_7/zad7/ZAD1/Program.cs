...
namespace ZAD1
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                channel.ExchangeDeclare("TOPIC_CENTRAL", "topic");
                ...
                for (int i = 0 ; i < 10; i++){
                    ...
                    if(i%2==0)
                    {
                        channel.BasicPublish("TOPIC_CENTRAL", "abc.def", properties, body);
                        Console.WriteLine("wysyłam wiadomosc "+i+" na kanał abc.def");
                        System.Threading.Thread.Sleep(2000);
                    }
                    else
                    {
                        channel.BasicPublish("TOPIC_CENTRAL", "abc.xyz", properties, body);
                        Console.WriteLine("wysyłam wiadomosc " + i + " na kanał abc.xyz");
                        System.Threading.Thread.Sleep(2000);
                    }
