    ...
    internal class KlientA
    {
        ...
        static void Main(string[] args)
        {
            ...
            var bus = Bus.Factory.CreateUsingRabbitMq(sbc =>
            {
                ...
                sbc.ReceiveEndpoint(host, "MainQueueB", ep => {
            ...
            bus.Start();
            Console.WriteLine("KLIENT BBBBB START");
            ConsoleKeyInfo cki;
            do
            {
                ...
                switch (cki.Key)
                {
                    case ConsoleKey.S:
                        try
                        {
                            ...
                            bus.Publish(new Komunikaty.StartZamówienia() { ilosc = intTemp, login = log, sender = "MainQueueB" });
                        }
                        catch { }
                        break;
                    case ConsoleKey.T:
